...
Route::get('api', [AppsController::class, 'user_view_connections'])->name('app-user-view-connections');

/* Route Api */
Route::group(['prefix' => 'api'], function () {
   // Route::get('hostels', [HostelsController::class, 'hostels']);
    Route::get('/paystack-callback-url', [HostelsController::class, 'paystackCallbackUrl']);
    Route::get('/payment-success', [HostelsController::class, 'paymentSuccess']);
    Route::get('/receipt', [HostelsController::class, 'getReceipt']);
});
...
Route::group(['prefix' => 'page'], function () {
    ...
    Route::get('api/hostels', [MiscellaneousController::class, 'coming_soon'])->name('misc-coming-soon');
